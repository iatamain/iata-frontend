...
canvas.addEventListener('mousemove', function(e){
	cell.x = e.offsetX / cof_x - 140;
	cell.y = e.offsetY / cof_y - 50; //Исправить
...
function game(){
	if(window.innerWidth / window.innerHeight > 1280 / 1150){
		canvasWidth = window.innerHeight / 1150 * 1280;
		canvasHeight = window.innerHeight;
		cof_y = window.innerHeight / 1150
		cof_x = window.innerHeight / 1150;
	}
	else{
		canvasWidth = window.innerWidth;
		canvasHeight = window.innerWidth / 1280 * 1150;
		cof_x = (window.innerWidth / 1280 * 1150)/1150;
		cof_y = window.innerWidth / 1280;
	}
